...
#ifndef NetworkPT_Plugin_404559626_h
#define NetworkPT_Plugin_404559626_h
...
namespace policy_translation {
    namespace srv {
        namespace dds_ {
            ...
            #define NetworkPT_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define NetworkPT_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define NetworkPT_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define NetworkPT_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define NetworkPT_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern NetworkPT_Request_*
            ...
            NetworkPT_Request_PluginSupport_copy_data(
                NetworkPT_Request_ *out,
                const NetworkPT_Request_ *in);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            NetworkPT_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                NetworkPT_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            NetworkPT_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                NetworkPT_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            NetworkPT_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            NetworkPT_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace policy_translation {
    namespace srv {
        namespace dds_ {
            ...
            #define NetworkPT_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define NetworkPT_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define NetworkPT_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define NetworkPT_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define NetworkPT_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern NetworkPT_Response_*
            ...
            NetworkPT_Response_PluginSupport_copy_data(
                NetworkPT_Response_ *out,
                const NetworkPT_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            NetworkPT_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            NetworkPT_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                NetworkPT_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            NetworkPT_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                NetworkPT_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            NetworkPT_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            NetworkPT_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* NetworkPT_Plugin_404559626_h */
